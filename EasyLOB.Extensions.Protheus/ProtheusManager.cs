...
namespace EasyLOB.Extensions.Protheus
{
    public class ProtheusManager
    {
        ...
        #region Properties Lock

        private Object lockConnectAndPrepareEnvironment = new Object();

        #endregion Properties Lock
        ...
        {
            lock (lockConnectAndPrepareEnvironment)
            {
        ...
        //public bool PrepareEnvironment(string environment = null, string empresa = null, string filial = null)
        {
            ...
            if (Empresa != empresa || Filial != filial)
            {
                object[] tabelas = { };
                //string[] tabelas = new string[1];
